        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12">
                <div class="card m-t-20">
                    <div class="body">
                      <form class="" action="<?php echo site_url('backend/pantau/update'); ?>" method="post">
                        <div class="form-group">
                          <div class="form-line">
                              <b>Lokasi</b>
                              <input type="text" id="lokasi" class="form-control" name="lokasi" placeholder="nama lokasi" required>
                          </div>
                      </div>
                      ...
                      <div class="form-group drop-custum">
                        <b>Zona</b>
                          <select name="zona" id="zona" class="form-control show-tick" required>
                      ...
                      <input type="hidden" name="id_titik" value="<?= $id ?>">
...
document.getElementById('lokasi').value="<?= $nama_titik ?>";
